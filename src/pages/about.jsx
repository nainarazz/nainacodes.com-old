  ...
  <Layout>
    <div className="about-container">
      <Helmet title={`About | ${config.siteTitle}`}>
        <meta name="description" content="Who am I, what I do, my favorite resources on the web" />
      </Helmet>
      ...
      <p>
        I came across web development later in my life and I fell in love with it. What I especially
        like about it is that you can immediately see the result of what you are doing and you can
        also play with your creativity a lot. The web is just so powerful nowadays, and you can
        pretty much do anything with it. I have decided to have my career built around web
        development.
      </p>
      <p>
        I have studied Software Engineering in Kampala, Uganda, and shortly after graduating, I got
        my first job as a software developer in a large software consulting company. Now I am
      ...
      <ul>
        ...
        <li>
          <a href="http://taniarascia.com/">Tania Rascia</a> — love the design of her site and great
          tutorials as well. Got the inspiration of my site from hers 😀
        </li>
        <li>
