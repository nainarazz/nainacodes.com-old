const config = {
  ...
  siteDescription: "A personal blog dedicated to JavaScript, React, Angular, Node, and other web technologies.", // Website description used for RSS feeds/meta description tag.
